...
const OrderCard = ({ order }) => {
  ...
  return (
    <div className="card-dark p-6">
      ...
      <div className="mt-4">
        <button onClick={() => generateOrderPDF(order)} className="inline-flex items-center gap-2 text-sm bg-dark-700 hover:bg-dark-600 text-brand-400 font-medium py-2 px-4 rounded-lg transition-colors">

            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {order.order_services.map((line) => (
                  <tr key={line.id}>
                    <td className="px-4 py-2 text-sm text-gray-900">{line.name}</td>
                    <td className="px-4 py-2 text-sm text-gray-500">{line.price} руб.</td>
                    <td className="px-4 py-2 text-sm text-gray-500">{line.quantity}</td>
                    <td className="px-4 py-2 text-sm text-gray-500">{line.total} руб.</td>
                  </tr>
                ))}
              </tbody>
            </table>

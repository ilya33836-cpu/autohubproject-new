    ...
    <>
      ...
      <div className="section-container mt-8">
        <div className="text-center mb-14">
          <p className="text-steel-300 font-bold tracking-[0.3em] uppercase text-xs mb-3">Свяжитесь с нами</p>
          <h1 className="text-4xl md:text-5xl font-black">Контакты</h1>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-14">
          <div className="card-dark p-8">
            <div className="w-12 h-12 rounded-lg bg-steel-300/10 flex items-center justify-center mb-5">
            ...
            <a href="https://yandex.ru/maps" target="_blank" rel="noreferrer" className="mt-6 inline-block text-steel-300 hover:text-steel-200 font-bold">Открыть на карте →</a>
          </div>
          ...
          <div className="card-dark p-8">
            ...
            <ul className="space-y-3 text-dark-300">
              <li>📞 <a href="tel:+79000000000" className="hover:text-steel-300 transition-colors">+7 (900) 000-00-00</a></li>
              <li>✉️ <a href="mailto:info@autohub.ru" className="hover:text-steel-300 transition-colors">info@autohub.ru</a></li>
              <li>💬 Telegram: <a href="https://t.me/autohub" className="hover:text-steel-300 transition-colors">@autohub</a></li>
            </ul>
          </div>
        </div>

      ...
      <div className="w-full max-w-md card-static-dark p-8 md:p-10">
        <div className="text-center mb-8">
          <div className="w-14 h-14 bg-brand-500/10 rounded-xl flex items-center justify-center mx-auto mb-4">
            <svg className="w-7 h-7 text-brand-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" /></svg>
          </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="w-full bg-brand-500 hover:bg-brand-600 text-dark-900 font-bold py-3 px-4 rounded-lg shadow-glow hover:shadow-glow-lg transition-all duration-300">Зарегистрироваться</button>
        </form>
        <div className="mt-8 pt-6 border-t border-dark-700 text-center">
          <p className="text-sm text-dark-400">Уже есть аккаунт?{' '}<Link href="/login" className="text-brand-400 hover:text-brand-300 font-bold">Войти</Link></p>
        </div>
      </div>
    </div>
  );

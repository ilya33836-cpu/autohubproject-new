...
export default function AdminCars() {
  ...
  if (loading) return <div className="text-center py-24 text-steel-400">Загрузка автомобилей...</div>;
    ...
    <AdminLayout>
      <div className="max-w-6xl mx-auto mt-8">
        ...
        <div className="mb-6">
          ...
          <input id="search-input-cars" type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder="Введите ID, марку, модель, гос. номер или VIN..." className="input-dark max-w-md" />
        </div>
